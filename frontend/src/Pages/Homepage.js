      ...
      <div className="w-full h-screen grid lg:grid-cols-[1fr_1fr] overflow-hidden bg-white">
        <div className="hidden lg:flex flex-col justify-center px-16 py-10 bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-700 text-white relative overflow-hidden">
          <div className="relative z-10">
            <h1 className="text-5xl xl:text-6xl font-black tracking-tight mb-4">Talk-A-Tive</h1>
            <p className="text-xl text-blue-100 leading-relaxed max-w-md">
              Connect instantly with friends, share moments, and enjoy real-time conversations.
            </p>

            <div className="mt-8 space-y-3">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-sm">⚡ Real-time messaging</div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-sm">🔒 Secure conversations</div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-sm">🌎 Stay connected anywhere</div>
            </div>
          </div>
        </div>
